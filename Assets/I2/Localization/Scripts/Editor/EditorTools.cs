...
{	
	public class GUITools
	{
		...
		{
            // Use the supported IMGUI API: Unity 6 no longer exposes the internal
            // s_RecycledEditor field used by the old reflection-based implementation.
            return GUI.TextField(position, text ?? string.Empty, maxLength, style);
		}
